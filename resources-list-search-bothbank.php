...
if($opfr==''||$opto==''){
	...
	$columns="select * ";
	$sql_ra=" from yp_tablec inner join yp_tabled on yp_tablec.pid=yp_tabled.pid where yp_tablec.bid='$opfr' and yp_tabled.bid='$opto' ";
	
	//$sql_ra=" from yp_tablec where bid='$opto' ";

	$sql1="select count(*) ".$sql_ra;
	$sql_ra.= " order by yp_tablec.rec_id";
