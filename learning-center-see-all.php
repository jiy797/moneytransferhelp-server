                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td valign="top" width="451">
                       <div class="breadcrumbs"><a href="index.php">Home</a> > <a href="learning-center.php">Learning Center</a> > <?php echo stripslashes($lrcat_name)?></div>
                       ...
                       <p><?php echo wordwrap(stripslashes($page_contents[1]), 50, "\n", 1)?></p>
                        ...
                        <br/>
							...
							<?php include('i_learning_cat.php'); ?>
