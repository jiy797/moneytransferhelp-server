...
<!--
	...
	function add_rec(){
		location.href="tableb_manage_frm.php";
	}
...
<table id="maintable" width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  ...
  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
	<TR>
	  <TD width="82%"><span class="para_heading">Table B List </span></TD>
	...
	<TR>
	  <TD colspan="2" align="center"><table width="50%" border="0" align="center" cellpadding="1" cellspacing="0" class="darkBG">
        <form name="form2" method="get" action="tableb_list.php?start=<?php echo $start; ?>">
          <tr>
	...
	<TR><TD colspan="2" align="center"><?php echo "<span class='red'>".$_SESSION['sess_msg']."</span>"; unset($_SESSION['sess_msg']);?></TD>
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="1" class="darkBG">
            ...
            <form name="form_frm" method="post" action="tableb_del.php">
              <tr>
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="2" cellspacing="1">
                    <tr height="22" >
                      ...
                      <td width="25%" align="left" class="darkBG">Transfer To Country</td>
                    ...
                    <tr bgcolor="<?php echo $bgcolor; ?>">
                      ...
                      <td width="10%" align="center" valign="top" class="text10"><?php if($line['status']=="Active"){ ?>
                                ...
                                <?php }?></td>
                      <td width="10%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><a href="tableb_manage_frm.php?id=<?php echo $line['rec_id'] ; ?>"><img src="images/edit16.gif" alt="EDIT" title="EDIT" width="16" height="16" border="0"></a></td>
                    </tr>
                    <?php }?>
                    <tr align="center">
                      <td colspan="6">
