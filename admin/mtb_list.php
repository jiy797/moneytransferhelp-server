...
<!--
	...
	function add_rec(){
		location.href="mtb_manage_frm.php";
	}

	function make_up(id,postion,start){
		location.href="mtb_position.php?id="+id+"&pos="+postion+"&start="+start+"&type=up";
	}
	function make_down(id,postion,start){
		location.href="mtb_position.php?id="+id+"&pos="+postion+"&start="+start+"&type=down";
	}
...
<table id="maintable" width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  ...
  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
	<TR>
	  <TD width="82%"><span class="para_heading">Manage Articles : List </span></TD>
	...
	<TR>
	  <TD colspan="2" align="center"><table width="50%" border="0" align="center" cellpadding="1" cellspacing="0" class="darkBG">
        <form name="form2" method="get" action="mtb_list.php?start=<?php echo $start; ?>">
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2" align="center" bgcolor="#FFFFFF">
				<?php
					$sql_vc="select * from yp_mtb_category";
	...
	<TR><TD colspan="2" align="center"><?php echo "<span class='red'>".$_SESSION['sess_msg']."</span>"; unset($_SESSION['sess_msg']);?></TD>
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="1" class="darkBG">
            ...
            <form name="form_frm" method="post" action="mtb_del.php">
              <tr>
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="2" cellspacing="1">
                    ...
                    <?php  
						...
						while($line=mysql_fetch_array($result)){$pagecounter+=1;
							...
							$sql_cname = "select cat_name from yp_mtb_category where cat_id=".$line['cat_id'];
                    ...
                    <tr bgcolor="<?php echo $bgcolor; ?>">
					  ...
					  <?php 
						$sql_cm="select count(*) from yp_mtb_comment where mid='".$line['rec_id']."' and status='Inactive'";
                      ...
                      <td width="8%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><a href="mtb_manage_frm.php?id=<?php echo $line['rec_id'] ; ?>"><img src="images/edit16.gif" alt="EDIT" width="16" height="16" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="mtb_comment_list.php?id=<?php echo $line['rec_id'] ; ?>"><img src="images/view.jpg" alt="COMMENTS" title="COMMENTS" width="16" height="16" border="0"></a></td>
                    </tr>
                    <?php }?>
                    <tr align="center">
                      <td colspan="9">
