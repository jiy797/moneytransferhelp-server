...
$columns="select * ";
$sql=" from yp_resource where 1=1";
...
<!--
	...
	function add_rec(){
		location.href="resource_manage_frm.php";
	}

	function make_up(id,postion,start){
		location.href="resource_position.php?id="+id+"&pos="+postion+"&start="+start+"&type=up";
	}
	function make_down(id,postion,start){
		location.href="resource_position.php?id="+id+"&pos="+postion+"&start="+start+"&type=down";
	}
...
<table id="maintable" width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  ...
  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
	<TR>
	  <TD width="82%"><span class="para_heading">Resource Article : List </span></TD>
	...
	<TR>
	  <TD colspan="2" align="center"><table width="50%" border="0" align="center" cellpadding="1" cellspacing="0" class="darkBG">
        <form name="form2" method="get" action="resource_list.php?start=<?php echo $start; ?>">
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2" align="center" bgcolor="#FFFFFF">
				<?php
					$sql_vc="select * from yp_resource_main";
				...
				<tr>
				  ...
				  <option value="<?php echo $lin_vc['rec_id']?>"><?php echo stripslashes($lin_vc['rec_name'])?></option>
				  <?php }?>
				  </select>
				  </td>
				  <td width="24%">&nbsp;</td>
	...
	<TR><TD colspan="2" align="center"><?php echo "<span class='red'>".$_SESSION['sess_msg']."</span>"; unset($_SESSION['sess_msg']);?></TD>
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="1" class="darkBG">
            ...
            <form name="form_frm" method="post" action="resource_del.php">
              <tr>
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="2" cellspacing="1">
                    <tr height="22" >
                      ...
                      <td width="27%" class="darkBG">Title </td>
                      <td width="26%" class="darkBG">Category</td>
                      <td width="10%" align="center" class="darkBG">Status</td>
                      <td width="13%" height="22" align="center" class="darkBG">Position</td>
                      <td width="12%" align="center" class="darkBG">Article Date</td>
                    ...
                    <?php  
						...
						while($line=mysql_fetch_array($result)){$pagecounter+=1;
							...
							$sql_cname = "select rec_name from yp_resource_main where rec_id=".$line['cat_id'];
							$cat_name  = getSingleResult($sql_cname);

							$sql_opfr="select cat_name from yp_resource_category where cat_id=".$line['option_from'];
							$cat_opfr= getSingleResult($sql_opfr);

							$sql_opto="select cat_name from yp_resource_category where cat_id=".$line['option_to'];
							$cat_opto= getSingleResult($sql_opto);
                    ...
                    <tr bgcolor="<?php echo $bgcolor; ?>">
                      ...
                      <td width="27%" align="left" valign="top" class="text10"><?php echo stripslashes($line['rec_name'])?><br>
                        <span class="text10_bold">From</span>: <?php echo stripslashes($cat_opfr)?> <br>
                        <span class="text10_bold">To</span>: <?php echo stripslashes($cat_opto)?> </td>
                      <td width="26%" align="left" valign="top" class="text10"><?php echo stripslashes($cat_name)?></td>
                      ...
                      <td width="12%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><?php echo getFullDate($line['rec_date'],'M d, Y')?></td>
                      <td width="9%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><a href="resource_manage_frm.php?id=<?php echo $line['rec_id'] ; ?>"><img src="images/edit16.gif" alt="EDIT" title="EDIT" width="16" height="16" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="resource_comment_list.php?id=<?php echo $line['rec_id'] ; ?>"><img src="images/view.jpg" alt="COMMENTS" title="COMMENTS" width="16" height="16" border="0"></a></td>
                    </tr>
                    <?php }?>
                    <tr align="center">
                      <td colspan="7">
