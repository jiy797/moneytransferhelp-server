...
<!--
	...
	function add_faq(){
		location.href="faq_manage_frm.php";
	}

	function make_up(id,postion,start){
		location.href="faq_position.php?id="+id+"&pos="+postion+"&start="+start+"&type=up";
	}
	function make_down(id,postion,start){
		location.href="faq_position.php?id="+id+"&pos="+postion+"&start="+start+"&type=down";
	}
...
<table id="maintable" width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  ...
  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
	<TR><TD width="82%"><span class="para_heading">Manage FAQ </span></TD>
	...
	<TR><TD colspan="2" align="center"><?php echo "<span class='red'>".$_SESSION['sess_msg']."</span>"; unset($_SESSION['sess_msg']);?></TD>
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="1" class="darkBG">
            ...
            <form name="faq" method="post" action="faq_del.php">
              <tr>
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="2" cellspacing="1">
                    <tr height="22" >
                      ...
                      <td width="24%" class="darkBG">Question</td>
                      <td width="25%" class="darkBG">Answer</td>
                      <td width="17%" align="left" class="darkBG">Category</td>
                      <td width="12%" align="left" class="darkBG">Position  </td>
                      <td width="12%" height="22" align="center" class="darkBG">Status</td>
                      <td width="7%" align="center" class="darkBG">&nbsp;</td>
                    </tr>
                    <?php  
						...
						while($line=mysql_fetch_array($result)){$pagecounter+=1;
							...
							$sql_fcname="select faq_cat_name from yp_faq_category where faq_cat_id='$faq_cat_id'";
							$faq_cat_name=getsingleresult($sql_fcname);
					?>
                    <tr bgcolor="<?php echo $bgcolor; ?>">
                      <td width="3%" height="20" align="center" valign="top">
                        <input type="checkbox" name="faq_ids[]" value="<?php echo $line['faq_id']; ?>"> </td>
                      <td width="24%" align="left" valign="top" class="text10"><?php echo stripslashes(substr($line['question'], 0, 50)); ?></td>
                      <td width="25%" align="left" valign="top" class="text10"><?php echo stripslashes(substr($line['answer'], 0, 50)); ?></td>
                      <td width="17%" align="left" valign="top" class="text10"><?php echo stripslashes($faq_cat_name); ?></td>
                      <td width="12%" align="left" valign="top" class="text10"><?php echo '[ '.$line['faq_position'].' ]'?>&nbsp; 
								<a href="#" onClick="javascript:make_up('<?php echo $line['faq_id']?>','<?php echo $line['faq_position']?>','<?php echo $start?>')"><u>UP</u></a> | <a href="#" onClick="javascript:make_down('<?php echo $line['faq_id']?>','<?php echo $line['faq_position']?>','<?php echo $start?>')"><u>DOWN</u></a></td>
                      <td width="12%" height="20" align="center" valign="top" class="text10">
                                ...
                                <?php }?></td>
                      <td width="7%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><a href="faq_manage_frm.php?faq_id=<?php echo  $line['faq_id'] ; ?>"><img src="images/edit16.gif" alt="Edit Content" width="16" height="16" border="0"></a></td>
                    </tr>
                    <?php }?>
                    <tr align="center">
                      <td colspan="7">
                    ...
                    <tr align="right" height="22">
                      <td colspan="7" class="brown_bar">
                        ...
                        <input type="button" name="Add" value="Add FAQ" class="buttons" onClick="add_faq()">
