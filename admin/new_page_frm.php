...
$sql="select * from yp_new_pages where page_id='$page_id'";
$result=executeQuery($sql);

if($line=mysql_fetch_array($result)){
	$page_id		= $line['page_id'];
	$mainpage		= $line['mainpage'];
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		  ...
		  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
            <TR>
              <TD width="85%"><span class="para_heading">New Page List : Manage Page Text</span></TD>
              <TD width="15%" align="right"><a href="new_page_list.php">[ BACK ]</a> </TD>
            </TR>
  ...
  <form method="post" action="new_page.php" enctype="multipart/form-data">
    <tr>
      <td><table width="100%" border="0" cellspacing="2" cellpadding="2" bgcolor="#FFFFFF">
        ...
        <tr valign="top">
          <td class="red">&nbsp;</td>
          <td height="0" class="contentBold">Main Page </td>
          <td><select name="mainpage" id="mainpage" class="textfield">
            <option value="HOME" <?php if($mainpage=='HOME'){ echo 'selected'; }?>>HOME</option>
            <option value="LEARNINGCENTER" <?php if($mainpage=='LEARNINGCENTER'){ echo 'selected'; }?>>LEARNING CENTER</option>
            <option value="REVIEWS" <?php if($mainpage=='REVIEWS'){ echo 'selected'; }?>>REVIEWS</option>
            <option value="COMPARESERVICES" <?php if($mainpage=='COMPARESERVICES'){ echo 'selected'; }?>>COMPARE SERVICES</option>
            <option value="RESOURCES" <?php if($mainpage=='RESOURCES'){ echo 'selected'; }?>>RESOURCES</option>
          </select>
          </td>
        </tr>
        <tr valign="top">
          <td class="red">*</td>
          <td height="0" class="contentBold">Page Title </td>
        ...
        <tr valign="top">
          ...
          <td height="0" align="left" class="main">Meta Keywords </td>
        ...
        <tr valign="top">
          <td align="center" class="red">&nbsp;</td>
          <td height="0" align="left" class="main">Meta Description </td>
        ...
        <tr valign="top">
          <td align="center" class="red">*</td>
          <td height="0" align="left" class="contentBold">Page Description </td>
        ...
        <tr valign="top">
          <td align="center">&nbsp;</td>
          <td height="0" align="left" class="main">&nbsp;</td>
          <td align="center">&nbsp;</td>
        </tr>
        <tr>
          <td align="center">&nbsp;</td>
