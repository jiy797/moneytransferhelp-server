...
$sql="select * from yp_learning_category where cat_id='$id'";
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
		  ...
		  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
            <TR><TD width="85%"><span class="para_heading">Learning Center : Category Add/Edit </span></TD>
            <TD width="15%" align="right"><a href="learning_category_list.php" class="menu">[ BACK ] &nbsp;</a></TD>
            </TR>
            ...
            <tr>
              <form action ="learning_category_manage.php" method="post" enctype="multipart/form-data" name="addForm" onSubmit="return validate(this)">
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellspacing="2" cellpadding="2">
                    ...
                    <tr>
                      ...
                      <td width="78%"><input name="cat_name" type="text" class="textfield" id="cat_name" value="<?php echo stripslashes($cat_name); ?>" size="40"></td>
                      </tr>
