...
<!--
	...
	function add_rec(){
		location.href="news_manage_frm.php";
	}

	function make_up(id,postion,start){
		location.href="news_position.php?id="+id+"&pos="+postion+"&start="+start+"&type=up";
	}
	function make_down(id,postion,start){
		location.href="news_position.php?id="+id+"&pos="+postion+"&start="+start+"&type=down";
	}
...
<table id="maintable" width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  ...
  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
	<TR>
	  <TD width="82%"><span class="para_heading">Manage News : Article List </span></TD>
	...
	<TR>
	  <TD colspan="2" align="center"><table width="50%" border="0" align="center" cellpadding="1" cellspacing="0" class="darkBG">
        <form name="form2" method="get" action="news_list.php?start=<?php echo $start; ?>">
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2" align="center" bgcolor="#FFFFFF">
				<?php
					$sql_vc="select * from yp_news_category";
	...
	<TR><TD colspan="2" align="center"><?php echo "<span class='red'>".$_SESSION['sess_msg']."</span>"; unset($_SESSION['sess_msg']);?></TD>
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="1" class="darkBG">
            ...
            <form name="form_frm" method="post" action="news_del.php">
              <tr>
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="2" cellspacing="1">
                    <tr height="22" >
                      ...
                      <td width="17%" class="darkBG">Title </td>
                      <td width="17%" class="darkBG">Category</td>
                      <td width="8%" align="center" class="darkBG">Status</td>
                      <td width="7%" align="center" class="darkBG">Featured</td>
                      <td width="11%" align="center" class="darkBG">Unapproved Comments</td>
                      <td width="13%" height="22" align="center" class="darkBG">Position</td>
                      <td width="10%" align="center" class="darkBG">Article Date</td>
                      <td width="6%" align="center" class="darkBG">Viewed</td>
                    ...
                    <?php  
						...
						while($line=mysql_fetch_array($result)){$pagecounter+=1;
							...
							$sql_cname = "select cat_name from yp_news_category where cat_id=".$line['cat_id'];
                    ...
                    <tr bgcolor="<?php echo $bgcolor; ?>">
                      ...
                      <td width="17%" align="left" valign="top" class="text10"><?php echo stripslashes($line['rec_name'])?></td>
                      <td width="17%" align="left" valign="top" class="text10"><?php echo stripslashes($cat_name)?></td>
                      <td width="8%" align="center" valign="top" class="text10"><?php if($line['status']=="Active"){ ?>
                                ...
                                <?php }?></td>
                      <td width="7%" align="center" valign="top" class="text10"><?php if($line['feature_status']=="Yes"){ ?>
									<img src="images/icon_status_green.gif" alt="Active" width="10" height="10">
                                <?php }?>
								<?php if($line['feature_status']=="No"){?>
									<img src="images/icon_status_red.gif" alt="Inactive" width="10" height="10">
                                <?php }?></td>
                      <td width="11%" align="center" valign="top" class="text10">
					  <?php 
						$sql_cm="select count(*) from yp_news_comment where nid='".$line['rec_id']."' and status='Inactive'";
                      ...
                      <td width="10%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><?php echo getFullDate($line['rec_date'],'M d, Y')?></td>
                      <td width="6%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><?php echo $line['rec_view']?></td>
                      <td width="8%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><a href="news_manage_frm.php?id=<?php echo $line['rec_id'] ; ?>"><img src="images/edit16.gif" alt="EDIT" title="EDIT" width="16" height="16" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="news_comment_list.php?id=<?php echo $line['rec_id'] ; ?>"><img src="images/view.jpg" alt="COMMENTS" title="COMMENTS" width="16" height="16" border="0"></a></td>
                    </tr>
                    <?php }?>
                    <tr align="center">
                      <td colspan="10">
                    ...
                    <?php }else{?>
                    <tr align="center">
                      <td colspan="10" height="20" class="red">NO RECORD AVAILABLE.</td>
                    </tr>
                    <?php }?>
                    <tr align="right" height="22">
                      <td colspan="10" class="brown_bar">
