...
$lname=getSingleResult("select rec_name from yp_learning where rec_id='$id'");
...
$columns="select * ";
$sql=" from yp_learning_comment where lid='$id'";
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
            <TR><TD width="85%"><span class="para_heading">Learning Center : <?php echo stripslashes($lname)?> -> Comment List</span></TD>
            <TD width="15%" align="right"><a href="learning_list.php" class="menu">[ BACK ] &nbsp;</a></TD>
            </TR>
            <TR>
              <TD colspan="2" align="center"><table width="50%" border="0" align="center" cellpadding="1" cellspacing="0" class="darkBG">
                <form name="form2" method="get" action="learning_comment_list.php">
                  <tr>
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="1" class="darkBG">
            <form name="form_ref" method="post" action="learning_comment_del.php">
              <tr>
                <td><table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="1" cellspacing="1">
                    ...
                    <tr bgcolor="<?php echo $bgcolor; ?>">
                      ...
                      <td width="14%" height="20" align="center" valign="top" class="text10">
                                ...
                                <?php }?></td>
                      <td width="10%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><a href="learning_comment_view.php?rec_id=<?php echo  $line['rec_id'] ; ?>&start=<?php echo $start; ?>&id=<?php echo $id; ?>"><img src="images/edit16.gif" alt="VIEW" title="VIEW" width="16" height="16" border="0"></a></td>
                    </tr>
                    <?php }?>
                    <tr align="center">
