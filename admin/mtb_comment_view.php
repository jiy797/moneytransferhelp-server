...
$sql="select * from yp_mtb_comment where rec_id='$rec_id'";
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
		  ...
		  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
             <TR>
				<TD width="85%"><span class="para_heading">Manage Article : <?php echo stripslashes($lname)?> -> Comment Details</span></TD>
	            <TD width="15%" align="right"><a href="mtb_comment_list.php?id=<?php echo $id?>" class="menu">[ BACK ] &nbsp;</a></TD>
             </TR>
            ...
            <tr>
                <td>
				  ...
				  <form action="mtb_comment_submit.php" method="post" enctype="multipart/form-data" name="comment_submit" id="comment_submit">
                    <tr>
