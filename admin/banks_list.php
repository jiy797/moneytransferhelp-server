...
$columns="select * ";
$sql=" from yp_banks where 1=1";

$se_name = checkInput($_GET['se_name']);

if($se_name!=''){
	$sql.=" and bank_name like '%$se_name%' ";
}
...
<!--
	...
	function add_rec(){
		location.href="banks_manage_frm.php";
	}
...
<table id="maintable" width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  ...
  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
	<TR>
	  <TD width="82%"><span class="para_heading">Banks List </span></TD>
	...
	<TR>
	  <TD colspan="2" align="center"><table width="50%" border="0" align="center" cellpadding="1" cellspacing="0" class="darkBG">
        <form name="form2" method="get" action="banks_list.php?start=<?php echo $start; ?>">
          <tr>
	...
	<TR><TD colspan="2" align="center"><?php echo "<span class='red'>".$_SESSION['sess_msg']."</span>"; unset($_SESSION['sess_msg']);?></TD>
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="1" class="darkBG">
            ...
            <form name="form_frm" method="post" action="banks_del.php">
              <tr>
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="2" cellspacing="1">
                    <tr height="22" >
                      ...
                      <td width="17%" class="darkBG">Bank ID </td>
                      <td width="30%" class="darkBG"><span class="darkBG">Bank Name</span></td>
                      <td width="30%" align="left" class="darkBG">Branch Details </td>
                    ...
                    <tr bgcolor="<?php echo $bgcolor; ?>">
                      ...
                      <td width="17%" align="left" valign="top" class="text10"><?php echo stripslashes($line['bank_id'])?></td>
                      <td width="30%" align="left" valign="top" class="text10"><?php echo stripslashes($line['bank_name'])?></td>
                      <td width="30%" align="left" valign="top" class="text10"><table width="980%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
                        <tr>
                          <td width="27%" valign="top" class="contentBold">ID</td>
                          <td width="73%" valign="top"><?php echo stripslashes($line['branch_id'])?></td>
                        </tr>
                        <tr>
                          <td valign="top" class="contentBold">Address</td>
                          <td valign="top"><?php echo stripslashes($line['branch_address'])?></td>
                        </tr>
                        <tr>
                          <td valign="top" class="contentBold">City</td>
                          <td valign="top"><?php echo stripslashes($line['branch_city'])?></td>
                        </tr>
                        <tr>
                          <td valign="top" class="contentBold">State</td>
                          <td valign="top"><?php echo stripslashes($line['branch_state'])?></td>
                        </tr>
                        <tr>
                          <td valign="top" class="contentBold">Country</td>
                          <td valign="top"><?php echo stripslashes($line['branch_country'])?></td>
                        </tr>
                      </table></td>
                      <td width="10%" align="center" valign="top" class="text10"><?php if($line['status']=="Active"){ ?>
                                ...
                                <?php }?></td>
                      <td width="10%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><a href="banks_manage_frm.php?id=<?php echo $line['rec_id'] ; ?>"><img src="images/edit16.gif" alt="EDIT" title="EDIT" width="16" height="16" border="0"></a></td>
                    </tr>
                    <?php }?>
                    <tr align="center">
                      <td colspan="6">
