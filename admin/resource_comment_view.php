...
$sql="select * from yp_resource_comment where rec_id='$rec_id'";
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
		  ...
		  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
             <TR>
				<TD width="85%"><span class="para_heading">resource Center : <?php echo stripslashes($lname)?> -> Comment Details</span></TD>
	            <TD width="15%" align="right"><a href="resource_comment_list.php?id=<?php echo $id?>" class="menu">[ BACK ] &nbsp;</a></TD>
             </TR>
                ...
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellspacing="2" cellpadding="2">
                    <tr>
                      ...
                      <td width="82%" valign="top"><?php echo stripslashes($rec_name); ?></td>
                    </tr>
                    <tr>
                      <td width="4%" align="right" class="red">&nbsp;</td>
                      <td width="14%" align="left" valign="top" class="contentBold">Comment</td>
                      <td width="82%" valign="top"><?php echo stripslashes($rec_desc); ?></td>
                    </tr>
                    <tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
