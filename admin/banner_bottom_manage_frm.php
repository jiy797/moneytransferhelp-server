...
if($id!=""){
	$sql="select * from yp_banner_bottom where b_id='$id'";
...
<TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
            <TR>
              <TD width="85%"><span class="para_heading">Bottom Banner List : Add/Edit </span></TD>
              <TD width="15%" align="bottom"><a href="banner_bottom_list.php" class="menu">[ BACK ] &nbsp;</a></TD>
            </TR>
            ...
            <tr>
              <form action="banner_bottom_manage.php" method="post" enctype="multipart/form-data" name="form_frm" onSubmit="return validate(this)">
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellspacing="2" cellpadding="2">
					...
					?>
                    <tr>
                      <td width="1%" align="bottom" valign="top" class="red">*</td>
				  ...
				  <?php }?>
                    ...
                    <?php }?>
                    <tr>
                      <td align="bottom" class="red">*</td>
                      <td class="contentBold">Upload Image</td>
                      <td>&nbsp;</td>
                      <td><input name="image1" type="file" class="textfield" id="image1">
                        <br>
                        [PLEASE UPLOAD IMAGE OF 728px * 90px. IMAGE WILL BE SHOWN AS IT IS ON SITE] </td>
                    </tr>
					<tr>
                      <td>&nbsp;</td>
