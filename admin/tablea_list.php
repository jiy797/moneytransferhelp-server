...
$columns="select * ";
$sql=" from yp_tablea where 1=1";

$se_country = checkInput($_GET['se_country']);

if($se_country!=''){
	$sql.=" and country='$se_country'";
}
...
<!--
	...
	function add_rec(){
		location.href="tablea_manage_frm.php";
	}
...
<table id="maintable" width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  ...
  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
	<TR>
	  <TD width="82%"><span class="para_heading">Table A List </span></TD>
	...
	<TR>
	  <TD colspan="2" align="center"><table width="50%" border="0" align="center" cellpadding="1" cellspacing="0" class="darkBG">
        <form name="form2" method="get" action="tablea_list.php?start=<?php echo $start; ?>">
          <tr>
		...
		?>
          <tr>
            <td><table width="100%" border="0" cellspacing="2" cellpadding="2" align="center" bgcolor="#FFFFFF">
                <tr>
                  <td width="33%" class="contentBold" align="right">Country</td>
                  <td width="43%" align="left"><select name="se_country" class="textfield" id="se_country" style="width:160px;">
						<option value="">---Select---</option>
							<?php
								while($lin_c=mysql_fetch_array($res_c)){						
							?>
								<option value="<?php echo $lin_c['country']?>" <?php if($lin_c['country']==$se_country){echo 'selected';}?>><?php echo stripslashes($lin_c['country'])?></option>
							<?php }?>
                        </select></td>
	...
	<TR><TD colspan="2" align="center"><?php echo "<span class='red'>".$_SESSION['sess_msg']."</span>"; unset($_SESSION['sess_msg']);?></TD>
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="1" class="darkBG">
            ...
            <form name="form_frm" method="post" action="tablea_del.php">
              <tr>
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="2" cellspacing="1">
                    <tr height="22" >
                      <td width="6%" height="22" align="center" class="darkBG">
                        <input type="checkbox" name="cb1" value="1" onClick="isValid(this.form)"></td>
                      <td width="19%" class="darkBG">Provider ID  </td>
                      <td width="30%" class="darkBG"><span class="darkBG">Provider Name</span></td>
                      <td width="25%" align="left" class="darkBG">Transfer From Country</td>
                    ...
                    <tr bgcolor="<?php echo $bgcolor; ?>">
                      <td width="6%" height="20" align="center" valign="top">
                        <input type="checkbox" name="ids[]" value="<?php echo $line['rec_id']; ?>"></td>
                      <td width="19%" align="left" valign="top" class="text10"><?php echo stripslashes($provider_id)?></td>
                      <td width="30%" align="left" valign="top" class="text10"><?php echo stripslashes($provider_name)?></td>
                      <td width="25%" align="left" valign="top" class="text10"><?php echo stripslashes($country)?></td>
                      <td width="10%" align="center" valign="top" class="text10"><?php if($line['status']=="Active"){ ?>
                                ...
                                <?php }?></td>
                      <td width="10%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><a href="tablea_manage_frm.php?id=<?php echo $line['rec_id'] ; ?>"><img src="images/edit16.gif" alt="EDIT" title="EDIT" width="16" height="16" border="0"></a></td>
                    </tr>
                    <?php }?>
                    <tr align="center">
                      <td colspan="6">
