...
$columns="select * ";
$sql=" from yp_resource_category where 1=1";
...
<!--
	...
	function add_rec(){
		location.href="resource_category_manage_frm.php";
	}
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
            <TR><TD width="82%"><span class="para_heading">Article Options : List</span></TD>
            ...
            <TR>
              <TD colspan="2" align="center"><table width="50%" border="0" align="center" cellpadding="1" cellspacing="0" class="darkBG">
                <form name="form2" method="get" action="resource_category_list.php?start=<?php echo $start; ?>">
                  <tr>
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="1" class="darkBG">
            <form name="form_ref" method="post" action="resource_category_del.php">
              <tr>
                <td><table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="1" cellspacing="1">
                    ...
                    <tr bgcolor="<?php echo $bgcolor; ?>">
                      ...
                      <td width="12%" height="20" align="center" valign="top" class="text10">
                                ...
                                <?php }?></td>
                      <td width="9%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><a href="resource_category_manage_frm.php?id=<?php echo  $line['cat_id'] ; ?>&start=<?php echo $start; ?>"><img src="images/edit16.gif" alt="EDIT" width="16" height="16" border="0"></a></td>
                    </tr>
                    <?php }?>
                    <tr align="center">
