...
$id=$_GET['id'];
$lname=getSingleResult("select rec_name from yp_mtb where rec_id='$id'");
...
$columns="select * ";
$sql=" from yp_mtb_comment where mid='$id'";
    ...
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
            <TR><TD width="85%"><span class="para_heading">Manage Articles : <?php echo stripslashes($lname)?> -> Comment List</span></TD>
            <TD width="15%" align="right"><a href="mtb_list.php" class="menu">[ BACK ] &nbsp;</a></TD>
            </TR>
            <TR>
              <TD colspan="2" align="center"><table width="50%" border="0" align="center" cellpadding="1" cellspacing="0" class="darkBG">
                <form name="form2" method="get" action="mtb_comment_list.php">
                  <tr>
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="1" class="darkBG">
            <form name="form_ref" method="post" action="mtb_comment_del.php">
              <tr>
                <td><table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="1" cellspacing="1">
                    <tr height="22" >
                      <td width="4%" height="22" align="center" class="darkBG">
                        <input type="checkbox" name="cb1" value="1" onClick="isVamid(this.form)"></td>
                      <td width="57%" align="left" class="darkBG">&nbsp;Name  </td>
                      <td width="14%" align="center" class="darkBG">Posted On </td>
                      <td width="15%" height="22" align="center" class="darkBG">Status</td>
                    ...
                    <tr bgcolor="<?php echo $bgcolor; ?>">
                      ...
                      <td width="57%" align="left" valign="top" class="text10">&nbsp;<?php echo stripslashes($line['rec_name']); ?></td>
                      <td width="14%" align="center" valign="top" class="text10"><?php echo getFullDate($line['posttime'],'M d, Y'); ?></td>
                      <td width="15%" height="20" align="center" valign="top" class="text10">
                                ...
                                <?php }?></td>
                      <td width="10%" align="center" valign="top" bgcolor="<?php echo $bgcolor; ?>"><a href="mtb_comment_view.php?rec_id=<?php echo  $line['rec_id'] ; ?>&start=<?php echo $start; ?>&id=<?php echo $id; ?>"><img src="images/edit16.gif" alt="VIEW" title="VIEW" width="16" height="16" border="0"></a></td>
                    </tr>
                    <?php }?>
                    <tr align="center">
