...
if($id!=""){
	$sql="select * from yp_tableb where rec_id='$id'";
...
<TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
            <TR><TD width="85%"><span class="para_heading">Table B List : Add/Edit </span></TD>
            <TD width="15%" align="right"><a href="tableb_list.php" class="menu">[ BACK ] &nbsp;</a></TD>
            </TR>
            ...
            <tr>
              <form action="tableb_manage.php" method="post" enctype="multipart/form-data" name="form_frm">
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellspacing="2" cellpadding="2">
                    ...
                    <tr>
                      <td width="2%" align="center" valign="middle" class="red">*</td>
                      <td width="23%" align="left" valign="top" class="contentBold">Transfer To Country</td>
                      <td width="75%">
