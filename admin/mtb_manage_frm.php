...
if($id!=""){
	$sql="select * from yp_mtb where rec_id='$id'";
...
<TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
            <TR><TD width="85%"><span class="para_heading">Manage Articles : Add/Edit </span></TD>
            ...
            <tr>
              <form action="mtb_manage.php" method="post" enctype="multipart/form-data" name="form_frm" onSubmit="return validate(this)">
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellspacing="2" cellpadding="2">
					...
					<?php 
						$sql_cat="select * from yp_mtb_category where status='Active'";
