...
if($id!=""){
	$sql="select * from yp_banner_top where b_id='$id'";
...
<TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
            <TR>
              <TD width="85%"><span class="para_heading">Top Banner List : Add/Edit </span></TD>
              <TD width="15%" align="top"><a href="banner_top_list.php" class="menu">[ BACK ] &nbsp;</a></TD>
            </TR>
            ...
            <tr>
              <form action="banner_top_manage.php" method="post" enctype="multipart/form-data" name="form_frm" onSubmit="return validate(this)">
                <td>
                  <table width="100%" border="0" bgcolor="#FFFFFF" cellspacing="2" cellpadding="2">
					...
					?>
                    <tr>
                      <td width="1%" align="top" valign="top" class="red">*</td>
