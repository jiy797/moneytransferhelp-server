<?php
	...
	$columns="select * ";
	$sql=" from yp_content_pages where 1=1";
...
<!--
	...
	function add_rec(){
		location.href="content_page_frm.php";
	}
//-->
</script>
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
		  ...
		  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
            <TR><TD><span class="para_heading">Content Page List </span></TD></TR>
			...
			<form name="form_frm" method="post" action="content_page_del.php">
              <tr>
                <td>
                    <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="2" cellspacing="1">
                      <tr>
                        <td width="20" class="darkBG" ><input type="checkbox" name="cb1" value="1" onClick="isValid(this.form)"></td> 
                        <td width="327" height="22" class="darkBG" >&nbsp;Page Title </td>
                        <td width="76" align="center" class="darkBG">Page ID </td>
                        <td width="104" align="center" class="darkBG">Status</td>
                        <td width="43" height="22" align="right" class="darkBG">&nbsp;</td>
                      </tr>
                      <?php 
					...
					?>
                      <tr bgcolor="<?php echo $bgcolor; ?>">
                        <td width="20" bgcolor="<?php echo $bgcolor; ?>" class="main"><input type="checkbox" name="ids[]" value="<?php echo $line['page_id'];?>"></td> 
                        <td width="327" height="20" bgcolor="<?php echo $bgcolor; ?>" class="mainBold"> 
                          &nbsp;<?php echo stripslashes($line['page_title']); ?></td>
                        <td width="76" align="center" bgcolor="<?php echo $bgcolor; ?>" class="main"><?php echo stripslashes($line['page_id']); ?></td>
                        <td width="104" align="center" bgcolor="<?php echo $bgcolor; ?>" class="main"><?php if($line['status']=="Active"){ ?>
                        ...
                        <?php }?></td>
                        <td width="43" height="20" align="center"><a href="content_page_frm.php?page_id=<?php echo $line['page_id']; ?>&start=<?php echo $start; ?>" class="menu"><img src="images/edit16.gif" alt="Edit Content" width="16" height="16" border="0"></a></td>
                      </tr>
                      <?php }?>
                      <tr align="center"> 
                        <td colspan="5"> 
