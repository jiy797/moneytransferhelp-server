...
$sql="select * from yp_news_category where cat_id='$id'";
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr>
		  ...
		  <TABLE WIDTH="98%" BORDER="0" CELLSPACING="2" CELLPADDING="2">
            <TR><TD width="85%"><span class="para_heading">Manage News : Category Add/Edit </span></TD>
            <TD width="15%" align="right"><a href="news_category_list.php" class="menu">[ BACK ] &nbsp;</a></TD>
            </TR>
            ...
            <tr>
              <form action ="news_category_manage.php" method="post" enctype="multipart/form-data" name="addForm" onSubmit="return validate(this)">
                <td>
