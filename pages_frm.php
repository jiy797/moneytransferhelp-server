                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td valign="top" width="451">
                       <div class="breadcrumbs"><a href="index.php">Home</a> > <?php echo stripslashes($page_title)?></div>
                       <h1><?php echo stripslashes($page_title)?></h1>
                       <p> <?php echo wordwrap(stripslashes($page_desc), 50, "\n", 1)?> </p>
