<?php
	...
	$page_contents = getPageContents("14");
	$b_page='NEWSLETTER UNSUBSCRIBE';
?>
                    ...
                    <td valign="top" width="451">
                       ...
                       <p> <?php echo wordwrap(stripslashes($page_contents[1]), 50, "\n", 1)?> </p>
						...
						<table width="98%" border="0" cellpadding="2" cellspacing="2">
						  <form name="verify_frm" method="post" action="newsletter_unsubscribe.php">
							...
							<tr>
							  <td align="right" class="contentBold">&nbsp;</td>
							  <td class="red">(* required)</td>
							  <td>&nbsp;</td>
							</tr>
							<tr>
							  <td width="5%" align="right" valign="top" class="red">*</td>
							  <td width="31%" align="left" valign="top" class="mainBold">Enter Your Email Address</td>
							  <td width="64%" valign="top">&nbsp;<input name="uns_email" type="text" class="textfield" id="uns_email" size="40" /></td>
							</tr>
