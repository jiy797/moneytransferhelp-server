...
<form name="compare" method="POST" action="compare-selected.php">
<div class="clear"></div>
<table width="100%" cellpadding="3" cellspacing="3">
  <tr>
    <td align="right" class="main"><input type="image" name="imageField" src="images/but-compare-sel.jpg" /></td>
  </tr>
</table>
...
<div class="<?php echo $divclass?>">
	<table cellpadding="0" cellspacing="0" class="entry" width="100%">
	 <tr>
		<td width="25"><input type="checkbox" name="cids[]" value="<?php echo $lin_fpro['rec_id']; ?>"></td>
		...
		<td>
			<div class="fl"><a href="<?php echo $non_secure_path."provider/".$lin_fpro['rec_id']?>/"><?php echo stripslashes($lin_fpro['rec_name'])?></a><br/><?php echo stripslashes(substr($lin_fpro['rec_desc'],0,90))?>...<br/>
			...
			<?php }?></div>
			<div class="fr" align="right"><?php $avg_rating = averageRating($lin_fpro['rec_id']); ?>
			<?php for($ictr=0;$ictr<$avg_rating;$ictr++){?>
			<img src="images/star.png" width="12" height="11" alt="" />
			<?php }?><br/><div class="smaller"><a href="<?php echo $non_secure_path."prodet/".$lin_fpro['rec_id']?>/ovew/">Overview</a><br/><a href="<?php echo $non_secure_path."prodet/".$lin_fpro['rec_id']?>/faq/">FAQ</a><br/><a href="<?php echo $non_secure_path."prodet/".$lin_fpro['rec_id']?>/rev/">Read Reviews</a></div></div>
			<div class="clear"></div>
		</td>
	  </tr>
...
<table width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td align="left" class="main"><input type="image" name="imageField" src="images/but-compare-sel.jpg" /></td>
  </tr>
</table>
