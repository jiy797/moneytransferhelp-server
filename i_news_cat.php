...
$columns="select * ";
$sql_lrcat=" from yp_news where cat_id='$cid' and status='Active' ";

$sql1="select count(*) ".$sql_lrcat;
$sql_lrcat.= " order by rec_date desc";
...
$sql_cname="select cat_name from yp_news_category where cat_id='$cid'";
...
?>
	<a href="<?php echo $non_secure_path."new/".$line_lrcat['rec_id']?>/<?php echo $ar_name?>/"><?php echo stripslashes($line_lrcat['rec_name'])?></a>
