<?php
	...
	$page_contents = getPageContents("11");
                    ...
                    <td valign="top" width="451">
                       ...
                       <p> <?php echo wordwrap(stripslashes($page_contents[1]), 50, "\n", 1)?> </p>
						...
						<table width="98%" border="0" cellpadding="2" cellspacing="2">
						  <form action="newsletter.php" method="post" name="form_ref" id="form_ref">
							...
							<tr>
							  ...
							  <td height="20" class="red">(* required)</td>
							  <td>&nbsp;</td>
							</tr>
							<tr>
							  <td width="7%" align="right" class="mainBold"><span class="red">*</span></td>
							  <td width="38%" height="30" align="left" class="mainBold">Enter Your Email Address</td>
							  <td width="55%"><input name="n_email" type="text" class="textfield" id="n_email" size="30" /></td>
							</tr>
							<tr align="center">
							  <td>&nbsp;</td>
							  <td>&nbsp;</td>
							...
							<tr align="center">
							  <td>&nbsp;</td>
							  <td>&nbsp;</td>
							  <td align="left"><input type="image" name="imageField" src="images/submit.gif" /></td>
							</tr>
						  </form>
					  </table>
						<br />
