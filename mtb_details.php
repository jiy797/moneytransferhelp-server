                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td valign="top" width="451">
                       <div class="breadcrumbs"><a href="<?php echo $non_secure_path?>index.php">Home</a> > <a href="<?php echo $non_secure_path?>mtb-see-all.php">Money Transfer Basics</a> > <?php echo stripslashes($rec_name)?></div>
                        ...
                        <div style="background-color:#e6f2f5; padding:10px;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <td class="smaller1"><a href="#" onClick="window.open('<?php echo $non_secure_path?>mtb_details_print.php?mid=<?php echo $mid;?>','','scrollbars=yes,width=700,height=600')">Printer Friendly</a></td>
                                ...
                                <div class="clear"></div>
                                 ...
                                 <div align="center">
								       <table width="100%" border="0" cellspacing="1" cellpadding="1">
											<form action="<?php echo $non_secure_path?>mtb_friend_submit.php" method="post" enctype="multipart/form-data" name="send_msg" id="send_msg">
											<?php if($_SESSION['sess_msg']!=''){?>
											<tr>
											...
											<tr>
											  ...
											  <td height="20"  class="main"><input name="mid" type="hidden" value="<?php echo $mid;?>" />
                        ...
                        <div style="background-color:#e6f2f5; padding:10px; display:none; padding:10px;" id="postcomment">
                            <div style="background-color:#ffffff; padding:10px; color:#444444;">
                                ...
                                <div class="clear"></div>
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
									<form action="<?php echo $non_secure_path?>mtb_comment_submit.php" method="post" enctype="multipart/form-data" name="send_comment" id="send_comment">
									<?php if($_SESSION['sess_msg_comment']=='PLEASE FILL BOTH THE FIELDS.'){?>
									<tr>
								 ...
								 <?php
										$sql_precomm="select * from yp_mtb_comment where mid='$mid' and status='Active'";
