<?php
	...
	$page_contents = getPageContents("15");
	$b_page='MTB ALL';
?>
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td valign="top" width="451">
                       <div class="breadcrumbs"><a href="<?php echo $non_secure_path?>index.php">Home</a> > <?php echo stripslashes($page_contents[0])?></div>
