...
$columns="select * ";
$sql_lrcat=" from yp_learning_category where status='Active' ";
...
//$sql_lrcat="select * from yp_learning_category where status='Active' order by cat_name";
//$res_lrcat=executeQuery($sql_lrcat);
	...
	<tr>
	  <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		while($line_lrcat=mysql_fetch_array($res_lrcat)){
			...
			$sql_a_chk="select count(*) from yp_learning where cat_id='".$line_lrcat['cat_id']."' and status='Active'";
			...
			<table width="100%" cellpadding="2" cellspacing="2">
			 <tr>
				<td valign="top">
				  ...
				  <br/>
				 <?php if($res_a_chk>0){?>
				  <a href="learning-center-see-all.php?cid=<?php echo $line_lrcat['cat_id']?>"><span class="red">&raquo;See All</span></a>
				  <br/>
				 <?php }?>
				
				  <?php
						$sql_lrar="select * from yp_learning where cat_id='".$line_lrcat['cat_id']."' and status='Active' and feature_status='Yes' order by rec_position limit 0,6";
				  ...
				  ?>
					  <a href="<?php echo $non_secure_path."learning/".$line_lrar['rec_id']?>/<?php echo $ar_name?>/"><?php echo stripslashes($line_lrar['rec_name'])?></a><br/>
				  <?php }?>
