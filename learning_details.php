<?php
	...
	$sql_cname="select cat_name from yp_learning_category where cat_id='$rec_cat_id'";
	$lrcat_name=getSingleResult($sql_cname);

	$b_page='LEARNING ARTICLE DETAILS';
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td valign="top" width="451">
                       <div class="breadcrumbs"><a href="<?php echo $non_secure_path?>index.php">Home</a> > <a href="<?php echo $non_secure_path?>learning-center.php">Learning Center</a>  > <a href="<?php echo $non_secure_path?>learning-center-see-all.php?cid=<?php echo $rec_cat_id?>"><?php echo stripslashes($lrcat_name)?></a> > <?php echo stripslashes($rec_name)?></div>
                        ...
                        <div style="background-color:#e6f2f5; padding:10px;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <td class="smaller1"><a href="#" onClick="window.open('<?php echo $non_secure_path?>learning_details_print.php?lid=<?php echo $lid;?>','','scrollbars=yes,width=700,height=600')">Printer Friendly</a></td>
                                ...
                                <div class="clear"></div>
                                 ...
                                 <div align="center">
								       <table width="100%" border="0" cellspacing="1" cellpadding="1">
											<form action="<?php echo $non_secure_path?>learning_friend_submit.php" method="post" enctype="multipart/form-data" name="send_msg" id="send_msg">
											<?php if($_SESSION['sess_msg']!=''){?>
											<tr>
											...
											<tr>
											  ...
											  <td height="20"  class="main"><input name="lid" type="hidden" value="<?php echo $lid;?>" />
                        ...
                        <div style="background-color:#e6f2f5; padding:10px; display:none; padding:10px;" id="postcomment">
                            <div style="background-color:#ffffff; padding:10px; color:#444444;">
                                ...
                                <div class="clear"></div>
								 ...
								 <table width="100%" border="0" cellspacing="1" cellpadding="1">
									<form action="<?php echo $non_secure_path?>learning_comment_submit.php" method="post" enctype="multipart/form-data" name="send_comment" id="send_comment">
									<?php if($_SESSION['sess_msg_comment']=='PLEASE FILL BOTH THE FIELDS.'){?>
									<tr>
								 ...
								 <?php
										$sql_precomm="select * from yp_learning_comment where lid='$lid' and status='Active'";
                       ...
                       <?php include('learning_related.php'); ?>

                    </td>
                    <td width="15"><img src="<?php echo $non_secure_path?>images/blank.gif" width="15" height="1" alt="" /></td>
                    <td valign="top">
                        <?php include('i_ads_right.php'); ?>
						
						<br style="line-height:10px;" />
						
						<?php include('i_discussion_board_right.php'); ?>

						<br style="line-height:10px;" />

						<?php include('i_ads1.php'); ?>
                    </td>
                  </tr>
				  <tr>
