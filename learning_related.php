...
$columns="select * ";
$sql_lrnr=" from yp_learning where cat_id='$rec_cat_id' and rec_id<>'$lid' and status='Active' ";

$sql1="select count(*) ".$sql_lrnr;
$sql_lrnr.= " order by rec_name";
...
//$sql_lrnr="select * from yp_learning where cat_id='$rec_cat_id' and rec_id<>'$lid' order by rec_position";
//$res_lrnr=executeQuery($sql_lrnr);
	...
	?>
		<td valign="top" width="50%" align="left"><div style="border-bottom:1px solid #dbdbdb; padding-top:10px; margin-bottom:10px;"><!--  --></div>
			<table width="100%" cellpadding="2" cellspacing="2">
			 <tr>
			   <td valign="top">
				  <a href="<?php echo $non_secure_path."learning/".$lin_lrnr['rec_id']?>/<?php echo $ar_name?>/"><b><?php echo stripslashes($lin_lrnr['rec_name'])?></b></a><br/>
