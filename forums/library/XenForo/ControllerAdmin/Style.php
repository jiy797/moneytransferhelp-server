 ...
 */
class XenForo_ControllerAdmin_Style extends XenForo_ControllerAdmin_Abstract
{
	...
	public function actionSave()
	{
		...
		return XenForo_CacheRebuilder_Abstract::getRebuilderResponse(
			$this, $writer->getExtraData(XenForo_DataWriter_Style::DATA_REBUILD_CACHES), XenForo_Link::buildAdminLink('styles')
		);
	}
