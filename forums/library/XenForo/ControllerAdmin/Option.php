...
class XenForo_ControllerAdmin_Option extends XenForo_ControllerAdmin_Abstract
{
	...
	public function actionIndex()
	{
		...
		return $this->responseView('XenForo_ViewAdmin_Option_ListGroups', 'option_list_groups', $viewParams);
	}
	...
	public function actionList()
	{
		...
		$group = $this->_getOptionGroupOrError($input['group_id']);
		...
		$viewParams = array(
			'group' => $group,
			'groups' => $optionModel->prepareOptionGroups($optionModel->getOptionGroupList()),
			'preparedOptions' => $optionModel->prepareOptions($optionModel->getOptionsInGroup($group['group_id'])),
			'canEditGroup' => $canEdit,
			'canEditOptionDefinition' => $canEdit
		);

		return $this->responseView('XenForo_ViewAdmin_Option_ListOptions', 'option_list_options', $viewParams);
	}
	...
	protected function _getGroupAddEditResponse(array $group)
	{
		...
		return $this->responseView('XenForo_ViewAdmin_Option_EditGroup', 'option_edit_group', $viewParams);
	}
	...
	public function actionDeleteGroup()
	{
		...
		else // show delete confirmation dialog
		{
			...
			return $this->responseView('XenForo_ViewAdmin_Option_DeleteGroup', 'option_delete_group', $viewParams);
		}
	}
	...
	protected function _getOptionAddEditResponse(array $option, array $relations = array())
	{
		...
		return $this->responseView('XenForo_ViewAdmin_Option_EditOption', 'option_edit_option', $viewParams);
	}
	...
	public function actionDeleteOption()
	{
		...
		else // show confirmation dialog
		{
			...
			return $this->responseView('XenForo_ViewAdmin_Option_DeleteOption', 'option_delete_option', $viewParams);
		}
	}
	 ...
	 * @return array
	 */
	protected function _getOptionGroupOrError($groupId)
	{
