...
abstract class XenForo_ControllerPublic_Abstract extends XenForo_Controller
{
	...
	protected function _assertNotBanned()
	{
		...
		{
			throw $this->responseException($this->responseReroute('XenForo_ControllerPublic_Error', 'banned'));
		}
	}
	...
	protected function _assertBoardActive($action)
	{
		...
		{
			throw $this->responseException($this->responseMessage($options->boardInactiveMessage));
		}
	}
