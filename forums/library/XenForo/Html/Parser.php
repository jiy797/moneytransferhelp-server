...
class XenForo_Html_Parser
{
	 ...
	 * Parses the HTML.
	 *
	 * @return XenForo_Html_Tag The root tag of the tree. This tag isn't really in the tree, so traversal should start with its children.
	 */
	public function parse()
	{
		$this->_currentTag = $this->_rootTag = new XenForo_Html_Tag('');
