...
class XenForo_Model_AdminNavigation extends XenForo_Model
{
	 ...
	 */
	public function getAdminNavigationEntries()
	{
		return $this->fetchAllKeyed('
			SELECT *
			FROM xf_admin_navigation
			ORDER BY parent_navigation_id, display_order
		', 'navigation_id');
	}
	 ...
	 * @return array [navigation id] => info
	 */
	public function getAdminNavigationEntriesWithParent($parentId)
	{
		return $this->fetchAllKeyed('
			SELECT *
			FROM xf_admin_navigation
	 ...
	 * @return array [navigation id] => info
	 */
	public function getAdminNavigationEntriesInAddOn($addOnId)
	{
		return $this->fetchAllKeyed('
			SELECT *
			FROM xf_admin_navigation
	 ...
	 * @return array|false
	 */
	public function getAdminNavigationEntryById($navigationId)
	{
	 ...
	 * @return array [navigation id] => info
	 */
	public function getAdminNavigationEntriesByIds(array $navigationIds)
	{
		if (!$navigationIds)
		{
			return array();
		...
		return $this->fetchAllKeyed('
			SELECT *
			FROM xf_admin_navigation
			WHERE navigation_id IN (' . $this->_getDb()->quote($navigationIds) . ')
		', 'navigation_id');
	}
