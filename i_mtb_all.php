...
$columns="select * ";
$sql_lrcat=" from yp_mtb where status='Active' ";
...
?>
	<a href="<?php echo $non_secure_path."mtb/".$line_lrcat['rec_id']?>/<?php echo $ar_name?>/"><?php echo stripslashes($line_lrcat['rec_name'])?></a>
